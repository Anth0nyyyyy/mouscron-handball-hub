...
const bureau = [
  ...
  },
  {
    ...
    image: "/lovable-uploads/Lucas.png", // Réutilisation de sa photo
  },
  {
    name: "Benjamin",
    role: "Responsable communication",
    image: "/lovable-uploads/benjamin.png", // Nouvelle photo à placer dans le dossier public/lovable-uploads/
  },
];
...
const entraineursJeunes = [
  ...
  },
  {
    ...
    role: "Coach U14",
    image: "/lovable-uploads/Antoine.png",
  },
  {
    name: "Lucas Vincent",
    role: "Coach U14",
  ...
  },
  {
    ...
    image: "/lovable-uploads/Dorian.png",
  },
  {
    name: "Nino Mancinone",
    role: "Coach Mini Handball",
...
// MAPPING DES ÉQUIPES CORRIGÉ (Centralisé et dynamique)
const categories = [
  {
    name: "Mini handball",
    color: "bg-hc-green-light",
    borderColor: "border-hc-green-light",
    img: "/lovable-uploads/WhatsApp_Image_2026-04-22_at_21.43.51 copy.jpeg" // Reçoit l'ancienne photo U18
  },
  {
    name: "U14",
    color: "bg-hc-green-light",
    borderColor: "border-hc-green-light",
    img: "/lovable-uploads/Capture d’écran 2026-08-12 131716.png" // Reçoit l'ancienne photo U16
  },
  {
    name: "U16",
    color: "bg-hc-green",
    borderColor: "border-hc-green",
    img: "/lovable-uploads/WhatsApp_Image_2026-04-27_at_10.58.05b copy.jpeg" // Reçoit l'ancienne photo U14
  },
  {
    name: "U18",
    color: "bg-hc-green-light",
    borderColor: "border-hc-green-light",
    img: "/lovable-uploads/WhatsApp_Image_2025-10-01_at_06.45.20 copy.jpeg" // Reçoit l'ancienne photo Seniors
  },
  {
    name: "Seniors",
    color: "bg-hc-green",
    borderColor: "border-hc-green",
    img: "/lovable-uploads/WhatsApp_Image_2026-05-09_at_22.07.47 copy.jpeg" // Reçoit l'ancienne photo Mini handball
  },
  {
    name: "Vétérans / Loisir",
    color: "bg-hc-orange",
    borderColor: "border-hc-orange",
    img: "/lovable-uploads/loisir.jpeg"
  }
];
      ...
      <div className="w-full py-8">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <section className="mb-16">
            ...
            {/* Layout Desktop 2x3 (Dynamique et synchronisé avec aspect-[4/3] object-cover) */}
                  ...
                  {c.name}
                    ...
                    <div className="flex flex-col items-center">
                      <img
                          ...
                          className={`w-full max-w-md aspect-[4/3] object-cover rounded-2xl shadow-lg border-4 ${c.borderColor} animate-fade-in`}
                      />
            ...
            {/* Layout Mobile/Tablet - Dynamique et synchronisé */}
