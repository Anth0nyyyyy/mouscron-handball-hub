...
const Home = () => {
  ...
  return (
      <div className="w-full">
        {/* Hero Section - Image ancrée en bas (bg-bottom) */}
        {/* Hero Section - Photo de groupe dézoomée et recentrée (bg-center) */}
        {/* Hero Section - Cadrage sur-mesure pour afficher tout le monde (60%) */}
        <section className="relative h-[70vh] bg-gradient-to-r from-green-800 via-green-600 to-amber-600 overflow-hidden">
          <div className="absolute inset-0 bg-black/30"></div>
          <div className="absolute inset-0 bg-cover bg-[position:center_60%]" style={{
        ...
        <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-green-900 via-green-800 to-amber-900">
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8 py-20 min-h-screen flex flex-col justify-center">
            ...
            {/* GRILLE SPECTACULAIRE 2x2 - Cartes unifiées en hauteur (h-full flex flex-col) */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 relative z-10 items-stretch">
              ...
              <div className="group relative h-full">
                ...
                <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl p-8 border-4 border-white/50 shadow-2xl transform group-hover:scale-105 transition-all duration-500 h-full flex flex-col justify-between">
                  <div>
              ...
              <div className="group relative h-full">
                ...
                <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl p-8 border-4 border-white/50 shadow-2xl transform group-hover:scale-105 transition-all duration-500 h-full flex flex-col justify-between">
                  ...
                  <div className="relative overflow-hidden rounded-2xl shadow-xl border-4 border-amber-200 group-hover:border-amber-400 transition-colors">
                    <img
                        src="/lovable-uploads/Capture d’écran 2026-08-12 131716.png"
                        alt="U16 conviviale"
                        className="w-full h-56 object-cover transform group-hover:scale-110 transition-transform duration-700"
                    />
                ...
                <div className="bg-gradient-to-r from-yellow-400 via-orange-500 to-amber-600 p-3 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-500">
                  <div className="bg-white/98 backdrop-blur-xl p-10 rounded-3xl text-center border-4 border-white/50">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                      ...
                      {/* BOUTON REDIRIGÉ VERS L'ANCRE DES TARIFS DE LA PAGE INFO */}
                      <Link to="/infos#tarifs" onClick={handleLinkClick}>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <div className="relative group">
                <img src="/lovable-uploads/WhatsApp_Image_2026-05-09_at_22.07.47 copy.jpeg" alt="Mini handball HC Mouscron" className="w-full h-48 object-cover rounded-lg shadow-lg group-hover:shadow-xl transition-shadow" />
                <div className="absolute inset-0 bg-green-800/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
              <div className="relative group">
                <img src="/lovable-uploads/WhatsApp_Image_2026-04-27_at_10.58.05b copy.jpeg" alt="U14 HC Mouscron" className="w-full h-48 object-cover rounded-lg shadow-lg group-hover:shadow-xl transition-shadow" />
                <div className="absolute inset-0 bg-green-800/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
              <div className="relative group">
                <img src="/lovable-uploads/Capture d’écran 2026-08-12 131716.png" alt="U16 HC Mouscron" className="w-full h-48 object-cover rounded-lg shadow-lg group-hover:shadow-xl transition-shadow" />
                <div className="absolute inset-0 bg-green-800/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
              <div className="relative group">
                <img src="/lovable-uploads/WhatsApp_Image_2026-04-22_at_21.43.51 copy.jpeg" alt="U18 HC Mouscron" className="w-full h-48 object-cover rounded-lg shadow-lg group-hover:shadow-xl transition-shadow" />
                <div className="absolute inset-0 bg-green-800/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
              <div className="relative group">
                <img src="/lovable-uploads/WhatsApp_Image_2025-10-01_at_06.45.20 copy.jpeg" alt="Seniors HC Mouscron" className="w-full h-48 object-cover rounded-lg shadow-lg group-hover:shadow-xl transition-shadow" />
                <div className="absolute inset-0 bg-green-800/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
              <div className="relative group">
        ...
        {/* Join Us Section */}
        <section className="py-20 bg-gradient-to-r from-[#1D4E34] via-[#286B43] to-[#D27C24]">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                {/* BOUTON REDIRIGÉ VERS L'ANCRE DES TARIFS DE LA PAGE INFO */}
                <Link to="/infos#tarifs" onClick={handleLinkClick}>
                  <Button size="lg" variant="secondary" className="bg-white text-hc-green hover:bg-hc-green hover:text-white shadow-lg font-semibold w-full sm:w-auto border-2 border-hc-green transition-colors">
                    Découvrir nos tarifs
                  </Button>
                </Link>
                <Link to="/contact" onClick={handleLinkClick}>
                  <Button size="lg" variant="outline" className="bg-white/10 text-white hover:bg-white hover:text-hc-green shadow-lg font-semibold w-full sm:w-auto border-2 border-white">
                    Nous contacter
                  </Button>
                </Link>
              </div>
